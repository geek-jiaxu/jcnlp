...
public class NgramSpellChecker {
  private static final String INDEX_STORE_DIR = "index"; // 索引文件存储位置
  private static final String DIC_STORE_DIR = "/data/ngram/dictionary.txt"; // 词典文件存储位置
  ...
  public static void main(String[] args) throws IOException {
    ...
    // 测试1
    String[] suggestions = sp.suggestSimilar("Todey", 5);
